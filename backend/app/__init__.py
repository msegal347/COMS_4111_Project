...
def create_app():
    ...
    from .controllers import company_routes, material_routes, environmental_routes, industrial_routes, general_categories_routes, sold_by_routes, query_routes, execute_query_routes, custom_query_routes
    ...
    app.register_blueprint(custom_query_routes.custom_query_bp)
